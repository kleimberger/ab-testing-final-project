...
required_size = function(s, d_min, Ns=1:1e8, alpha=0.05, beta=0.2) {
    for (N in Ns) {
...
# the standard error for N=1, is equal to the measured standard error with 5000
# in each group times sqrt(5000)
# required_size(s=0.00515*sqrt(5000), d_min=0.02) #s of 0.00515 is per pageview. 5000 is the total number of pageviews
